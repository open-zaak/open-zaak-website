...
This community manages the [OpenZaak code](https://github.com/open-zaak). It received the support of the Codebase Stewards from the [Foundation for Public Code](https://publiccode.net).

### Working together on OpenZaak

This codebase represents a good case of collaboration in between its community of municipalities, vendors and Dimpact. The synergy has made OpenZaak available to every municipality in the Netherlands.
